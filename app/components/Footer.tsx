...
export default function Footer() {
    return (
        <footer className="section pt-12 pb-8 border-t border-white/10">
            <div className="grid md:grid-cols-4 gap-8 mb-12">
                ...
                <div className="md:col-span-2">
                    ...
                    <div className="flex gap-4">
                        <a
                            href="#"
                            className="w-10 h-10 rounded-lg glass glass-hover flex items-center justify-center text-gray-400 hover:text-primary-light transition-colors"
                            aria-label="Facebook"
                        >
                ...
                {/* Quick Links */}
                <div>
                    <h4 className="text-lg font-display font-bold mb-4 text-white">Quick Links</h4>
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link href="/projects" className="text-gray-400 hover:text-primary-light transition-colors">
                                Projects
                            </Link>
                        </li>
                        <li>
                            <Link href="/brands" className="text-gray-400 hover:text-primary-light transition-colors">
                                Trusted Brands
                            </Link>
                        </li>
                        <li>
                ...
                {/* Services */}
                <div>
                    <h4 className="text-lg font-display font-bold mb-4 text-white">Our Services</h4>
                    <ul className="space-y-2">
                        <li>
                            <Link href="/services/construction" className="text-gray-400 hover:text-primary-light transition-colors">
                                Construction
                            </Link>
                        </li>
                        <li>
                            <Link href="/services/solar" className="text-gray-400 hover:text-primary-light transition-colors">
                                Solar Energy
                            </Link>
                        </li>
                        <li>
                            <Link href="/services/real-estate" className="text-gray-400 hover:text-primary-light transition-colors">
                                Real Estate
                            </Link>
                        </li>
                    </ul>

                    <h4 className="text-lg font-display font-bold mt-6 mb-4 text-white">Contact</h4>
